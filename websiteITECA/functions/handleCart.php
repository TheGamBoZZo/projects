    ...
    if(isset($_POST['scope']))
    {
        ...
        switch ($scope)
        {
            case "add":
                ...
                $chk_existing_cart = $_SESSION =  "SELECT * FROM carts WHERE prod_id='$prod_id' AND user_id='$user_id' ";
            ...
            case "delete":
                ...
                $chk_existing_cart = $_SESSION =  "SELECT * FROM carts WHERE id='$cart_id' AND user_id='$user_id' ";
                $chk_existing_cart_run = mysqli_query($con,$chk_existing_cart);
