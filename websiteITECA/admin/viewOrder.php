                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <hr>
                            <h4>Total Price: <span class="float-end fw-bold"><?=$data['total_price']?></span>
                            </h4>
                            <hr>
                            ...
                            <div class="mb-3">
                                ...
                                <button type="submit" name="update_order_btn" class="btn btn-dark mt-3">Update Status</button>
                                </form>
                            </div>
                        </div>
                    </div>
